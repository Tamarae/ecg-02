      ...
      <thead>
        <tr>
          <!-- Let us assume that all texts have a filename, ID, and
               title. -->
          <th><i18n:text i18n:key="filename">Filename</i18n:text></th>
          <th>ID</th>
          <th><i18n:text i18n:key="file_title">Title</i18n:text></th>
          <!-- xsl:if test="result/doc/arr[@name='author']/str">
            <th><i18n:text i18n:key="editor">Author</i18n:text></th>
          </xsl:if> -->
